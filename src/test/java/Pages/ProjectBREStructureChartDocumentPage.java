...
//    public static By SelectUserAdmin = By.xpath("(//span[@class='mat-option-text'])[1]");
//
...
//    By selectStructureNewProject = By.xpath("//span[contains(text(),' dev test structure ')]");
//    By  selectStructureProject = By.xpath("//span[contains(text(),' dev test structure ')]");
//    public static  By Logout = By.xpath("//span[@mattooltip='Logout']");
//    By OpenStructurePdf = By.xpath("//span[contains(text(),' 2 page b matched.pdf ')]");
