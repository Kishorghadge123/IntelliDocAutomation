...
public By cancelcategory=By.xpath("(//mat-icon[contains(text(),'close')])[3]");
...
@Step("click cancel category")
public void clickcnacelcategory(){
        driver.findElement(cancelcategory).click();
    }
...
//
//    }
    @Step("enter database name")
    public void ClickDatasetName(String text) {
        Random r = new Random();
        char first_c = (char) (r.nextInt(26) + 'a');
        char second_c = (char) (r.nextInt(26) + 'a');
        driver.findElement(DatasetName).sendKeys(text + first_c + second_c);
