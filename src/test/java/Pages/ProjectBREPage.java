...
//    By DataSets = By.xpath("(//span[contains(text(),'Datasets')])[2]");
...
//    By dropdown=By.xpath("(//mat-select[@role='combobox'])[11]");
//    public static By SelectPatientDemographics = By.xpath("//span[contains(text(),'Age')]");
//    By AddBREEntity = By.xpath("//span[contains(text(),'Attribute / Variable')]");
...
//    public By ready=By.xpath("(//span[@class='mat-option-text'])[1]");
//    public  By rejected=By.xpath("(//span[@class='mat-option-text'])[2]");
//    public  By processesd=By.xpath("(//span[@class='mat-option-text'])[3]");
//    By NameAttribute = By.xpath("//span[contains(text(),'City')]");
...
//    By AddressAttribute = By.xpath("//span[contains(text(),'City')]");
//    By StateAttribute = By.xpath("(//span[contains(text(),'Name')])[4]");
...
//    By ClickOnAddBREDataSet = By.xpath("//span[contains(text(),' PratikshaQA - QA-Automation ')]");
...
//    By SelectBREDatasetHeaderDXCode = By.xpath("//span[contains(text(),'name')]");
...
//public  By entity=By.xpath("//div[@class='mat-select-arrow ng-tns-c163-63']");
//    public  By hccc=By.xpath("(//span[contains(text(),' PatientDemographics ')])[2]");
...
//    By Entity = By.xpath("//span[contains(text(),'Replace String')]");
//
...
//
//public void  clickonentity() throws InterruptedException {
//    driver.findElement(entity).click();
//    Thread.sleep(1000);
////    driver.findElement(patientdemography).click();
//}
//
//public void clickonpatientdemography(){
//    driver.findElement(hccc).click();
//}
//    //Constructor
...
//
//    public void ClickOnFirstTrueBoxButton() throws InterruptedException {driver.findElement(TrueBox1).click();
//        Thread.sleep(3000);
//    }
//
...
//        driver.findElement(processesd).click();
//    }
//
