...
//
//    By clickoneditencouter=By.xpath("(//span[contains(text(), 'E111')]//following::mat-icon)[1]");
//
...
//   public By OpenReadyDocument = By.xpath("//span[contains(text(),' CEN2129937_removed.pdf ')]");
...
//    By OpenReadyDocumentICD = By.xpath("//span[contains(text(),' CEN2129937_removed.pdf ')]");
//    By OpenRejectedDocument = By.xpath("//span[contains(text(),' inputDocs/M-Medical/1.jpg ')]");
...
//    By ClickOnRejectedDocument=By.xpath("//span[contains(text(),' inputDocs/M-Medical/1.jpg ')]");
//
...
//    By EncounterDetails = By.xpath("//span[contains(text(),' Dr.Birla ')]");
...
//    By familyproject=By.xpath("//span[contains(text(),' Famhis ')]");
//    By familydoc=By.xpath("//span[contains(text(),' CEN2132354.pdf ')]");
//    By EditICDCodeDetails = By.xpath("//*[text()='Patient Demographics']//following::button[6]");
//    By PickCommentAdd = By.xpath("(//span[contains(text(),'ADD')])[2]");
//    By selecticd=By.xpath("//span[contains(text(),' No HCC codes ')]");
...
//    public By cancelicd=By.xpath("(//span[contains(text(),'Cancel')])[5]");
...
//    public By clickonIcd=By.xpath("(//div[contains(@class,'mat-select-arrow-wrapper ng')])[2]");
//    public By icdtextfield=By.xpath("//input[@data-placeholder='Add ICD']");
//    public By hcc=By.xpath("//div[@class='mat-form-field-infix ng-tns-c97-306']");
//    public By add=By.xpath("(//div[contains(text(),'DOS End Date ')])[1]");
...
//    @Step("click family project")
//    public  void selectfamilyproject(){
//        driver.findElement(familyproject).click();
//    }
//    @Step("select family document")
//    public  void  clickOnFamilyDocument(){
//        driver.findElement(familydoc).click();
//    }
//
...
//public void clickronicCondition(){
...
//    }
//
//    public void selectICD(){
//        driver.findElement(selecticd).click();
//    }
//
...
//      driver.findElement(cancelicd).click();
//}
...
//    @Step("click on clickaddbutton")
//    public void clickaddbutton(){
//        driver.findElement(add).click();
//    }
//
//    @Step("clickonIcd")
//    public  void  clickonIcd(){
//        driver.findElement(clickonIcd).click();
//    }
//
//    @Step("Enter Icd")
//    public  void  entericd(){
//        driver.findElement(icdtextfield).sendKeys("E1122");
//    }
//    @Step("click on hcc")
//    public void clickonhcc(){
//        driver.findElement(hcc).click();
//    }
//
//
//
...
//        driver.findElement(addEncounterDetails).click();
//}
