...
//    WebDriver driver;
////    AssertionsFunction assertionsFunction=new AssertionsFunction(driver);
//    /////locators
//    public static By DocumentBtn = By.xpath("(//img[contains(@class,'mat-tooltip-trigger')])[6]");
//    public static  By sreadydoc=By.xpath("//span[contains(text(),' inputDocs_dev test semi structured_Semistructure_document.pdf ')]");
...
//    public By rejdoc=By.xpath("//span[contains(text(),' structured.pdf ')]");
...
//    public By freedocument1=By.xpath("//span[contains(text(),' QA-Automation-FreeForm ')]");
...
//    By readydoc=By.xpath("//span[contains(text(),' QA-DemoDocument_inputDocs_structureaudit_newdocument for attribute checking 1.png ')]");
//    By SearchProject = By.xpath("//span[contains(text(),' QA-Automation BRE ')]");
//    public By SearchBox = By.xpath("//input[@data-placeholder='Search']");
//    public By projectname=By.xpath("//span[contains(text(),' QA-Automation BRE ')]");
//    public  By semiprojectname=By.xpath("//span[contains(text(),' QA-Automation Semistrcture ')]");
...
//    public static By SelectMedicalChartProject = By.xpath("//span[contains(text(),' M-Medical ')]");
//    By SelectMedicalChartProjectICD = By.xpath("//span[contains(text(),' M-Medical ')]");
//    public By SearchDocument = By.xpath("//mat-icon[contains(text(),'search')]");
//    public By pdoc=By.xpath("(//button[contains(text(),' Processed ')])[1]");
...
//   public By doc=By.xpath("//span[contains(text(),' Documents ')]");
...
//public By processdedoc=By.xpath("//span[contains(text(),' download.jpg ')]");
...
//By filterbtn=By.xpath("//span[contains(text(),' Filter ')]");
//By clickstatusdropdown=By.xpath("(//span[contains(text(),'Ready')])[2]");
//By clickrejectedstatus=By.xpath("//span[contains(text(),' Rejected ')]");
...
//    public By DeleteRule1Condition1 = By.xpath("(//mat-icon[contains(text(),'delete')])[2]");
...
//    }
//    public  void ClickProceeseddocument(){
//        driver.findElement(processdedoc).click();
//    }
//
//    @Step("ClickZoomOut")
...
//        driver.findElement(clickstatusdropdown).click();
//    }
//    @Step("click on dropdown")
//    public void selectrejected(){
//        driver.findElement(clickrejectedstatus).click();
//    }
//
//    @Step("clickSubmit")
