...
//    By SelectLeadSample = By.xpath("(//span[@class='mat-option-text'])[1]");
//    By SelectLeadAdmin = By.xpath("//mat-label[text()='Lead']//following::mat-option[1]");
//    By SelectLead = By.xpath("//span[contains(text(),' pratiksha.bagal@neutrinotechlabs.com ')]");
...
//    By ClickDocumentStructure = By.xpath("//mat-select[@formcontrolname='documentStructure']");
...
//    By SelectTemplate = By.xpath("//button[contains(text(),'QA-Automation')]");
//    public static By TemplateSelected = By.xpath("//*[@role='gridcell'][1]");
//By tempbtn=By.xpath("//span[contains(text(),'Templates')]");
//    //*[@role='gridcell'][1]
...
//    public static By SelectRoleAdmin = By.xpath("//button[contains(text(),'PratikshaQA')]");
//    public static By SelectedRoleAdmin = By.xpath("(//button[contains(text(),'Operator')])[1]");
//
//
//    By SelectRoleSuperVisor = By.xpath("//button[contains(text(),'AE Supervisor')]");
//    By AddUser = By.xpath("(//span[@class='mat-option-text'])[1]");
//    By AddUserAdmin = By.xpath("(//mat-icon[contains(text(),'add_circle_outline')])[2]");       //esc method
//    public static By SelectUserAdmin = By.xpath("//span[contains(text(),' pratiksha.bagal@neutrinotechlabs.com ')]");
...
//    By CreateButtonOnProjectPage = By.xpath("(//button[contains(@class,'mat-focus-indicator ml-2 ng-tns')])[1]");
...
//    public   By CancelOnProject = By.xpath("(//span[@class='mat-button-wrapper'])[19]");
...
//    public By TableStructure = By.xpath("//*[contains(text(),' list ')]");
...
//    By DeleteAttributeFieldName = By.xpath("(//mat-icon[contains(text(),'delete')])[7]");
...
//        Random r = new Random();
//        char first_c = (char) (r.nextInt(26) + 'b');
//        char second_c = (char) (r.nextInt(26) + 'b');
//
//
//
//        driver.findElement(ProjectName).sendKeys(text + first_c + second_c);
//    }
//
//
//    @Step("ClickOnLeadBtn")
...
//    }
//    @Step("Clickon template tab")
//    public void clickontemptab(){
//        driver.findElement(tempbtn).click();
//    }
//
//
//
...
//    }
//    @Step("Clickonuser")
//    public void clickonconoperatorrole(){
//        driver.findElement(SelectedRoleAdmin).click();
//    }
//    @Step("ClickUpdateBtn")
...
//
//        driver.findElement(SearchProject).sendKeys("QA-Auto");
//    }
//
