...
//    By ChooseDataSet = By.xpath("(//button[contains(text(),'PratikshaQA')])");
//    By BREChooseDataSet = By.xpath("//button[contains(text(),' PratikshaQA ')]");
//    public static By SelectDataSet = By.xpath("//button[contains(text(),' QA-Automation ')]");
...
//    By BRESelectDataSet = By.xpath("//button[contains(text(),' QA-Automation ')]");
//    By OperatorValueExistsIn = By.xpath("//span[contains(text(),'Exists In')]");
//    By PreDefinedDataSet = By.xpath("//span[contains(text(),'dataset')]");
//    By SelectPreDefinedDataSet = By.xpath("//span[contains(text(),' PratikshaQA - QA-Automation ')]");
//    By DataSetHeader = By.xpath("//span[contains(text(),'Dataset Header')]");
//    By SelectDataSetHeader = By.xpath("//span[contains(text(),'name')]");
