...
public class CreateUserPage
{
    ...
    public  By UserBtn = By.xpath("(//img[contains(@class,'mat-tooltip-trigger')])[1]");
    By searchbar=By.xpath("//input[@data-placeholder='Search']");
    public  By CreateUserBtn = By.xpath("//span[text()=' Create User ']");
    ...
    public By list=By.xpath("(//mat-icon[contains(text(),'list')])[1]");
    ...
    public   By cancelButton=By.xpath("(//span[contains(text(),'Cancel')])[2]");
