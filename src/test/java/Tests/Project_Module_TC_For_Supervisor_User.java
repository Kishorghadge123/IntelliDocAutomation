...
//
//public class Project_Module_TC_For_Supervisor_User extends BaseTest {
//
...
//
//    @Severity(SeverityLevel.CRITICAL)
//    @Story("story_id: 036-verify_auditor_analytics_section_revamp")
//    @Description("verify_auditor_analytics_section_revamp")
//    @Test(priority =36,groups = "smoke", description = "verify_auditor_analytics_section_revamp")
//    public void verify_auditor_analytics_section_revamp() throws InterruptedException, IOException {
//        //IN924 As an auditor I should have an ability to search in the auditor's document navigator, so that it will be easier for me to search for the required document
//        //IN888 Revamp of Auditor analytics section
//        //IN925 As an auditor, I want to filter all the medical chart based on the status of the medical charts
//        WebDriver driver = DriverFactory.getInstance().getDriver();
//        assertionsFunction=new AssertionsFunction(driver);
//        Thread.sleep(2000);
//        project = new Project_Module(driver);
//
//        project.clickonauditbtn();
//        Thread.sleep(1000);
//project.clickondropdown();
//Thread.sleep(1000);
//project.selectproject();
//        Thread.sleep(1000);
//        Assert.assertTrue(assertionsFunction.isPresent(project.getcount()));
//        project.clickonstatusfilter();
//        Thread.sleep(1000);
//        project.clickonreadystatus();
//        Thread.sleep(1000);
//        project.clickOutside();
//        Thread.sleep(1000);
//project.clickondocfilter();
//Thread.sleep(3000);
//project.Enterdocumentname(ReadProps.readAttr("documentname"));
//project.clickonserachicon();
//Thread.sleep(2000);
//project.clickonclearsearch();
//Thread.sleep(1000);
//project.clickonauditor();
//Thread.sleep(1000);
//project.clickassigneesearchicon();
//Thread.sleep(1000);
