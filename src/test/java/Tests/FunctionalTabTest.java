...
//
//public class FunctionalTabTest extends BaseTest
//{
...
//        //TC 13.4 Horizonta  WebDriver driver = DriverFactory.getInstance().getDriver();l Templates Tab and Navigate Backward.
//        WebDriver driver = DriverFactory.getInstance().getDriver();
//
