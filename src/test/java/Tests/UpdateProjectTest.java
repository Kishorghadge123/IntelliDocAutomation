...
//        assertions.isPresent(ProjectPageObj.UpdateProject);
//        Thread.sleep(1000);
...
//        assertions.isPresent(userPage.UpdateUser);
//        Thread.sleep(2000);
//    }
//
//
...
//        assertions.isPresent(ProjectPageObj.CancelOnProject);
//        Thread.sleep(4000);
//    }
//
//    @Severity(SeverityLevel.CRITICAL)
...
//        Thread.sleep(2000);
//        ProjectPageObj.SearchProjectAdmin();
//        assertions.isPresent(ProjectPageObj.SearchProject);
//        Thread.sleep(1000);
//
//    }
//    @Test(priority = 20)
